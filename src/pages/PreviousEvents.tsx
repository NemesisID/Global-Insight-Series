...
export function PreviousEvents() {
  ...
  const allEvents = [
    {
      title: "Asia-Pacific Education Summit 2025",
    ...
    {
      title: "International Research Collaboration Workshop",
    ...
    {
      title: "Student Leadership and Global Citizenship Forum",
      date: "June 5-7, 2025",
      day: "05",
      month: "JUN",
      location: "Singapore",
    ...
    {
      title: "GIS Annual Conference 2025",
      date: "May 15-17, 2025",
      day: "15",
      month: "MAY",
      location: "UPN Veteran Jawa Timur",
    ...
    {
      title: "Faculty Exchange Program Kickoff",
      date: "April 10, 2025",
      day: "10",
      month: "APR",
      location: "Online",
    ...
    {
      title: "Sustainable Development Goals Symposium",
    ...
    {
      title: "Quality Assurance in Higher Education Workshop",
    ...
    {
      title: "Innovation and Entrepreneurship in Academia Seminar",
    ...
    {
      title: "Global Health Challenges Conference",
    ...
    {
      title: "Open Educational Resources Workshop",
    ...
    {
      title: "Climate Action in Universities Summit",
    ...
    {
      title: "Academic Leadership Development Program",
    ...
    {
      title: "Virtual Reality in Education Showcase",
    ...
    {
      title: "International PhD Students Symposium",
    ...
    {
      title: "Cybersecurity in Higher Education Forum",
    ...
    {
      title: "Language and Cultural Exchange Program Launch",
      date: "August 28, 2024",
      day: "28",
      month: "AUG",
